...
content.js progress (2026-09-24): orchestration helpers moved to services/{diagnostics,overview-catalog,pet-edit,friend-directory,retention,status,partner-ranking,worker-control}.js; content.js is ~460 lines of composition/boot wiring. Remaining in content.js: feature forwarders, refresh plumbing, the tab-identity/heartbeat/pagehide lifecycle and the OWEH.boot helper bag. Guard every further move with tests/content-boot-wiring.test.js.
